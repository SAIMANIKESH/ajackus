(function(){const m=document.createElement("link").relList;if(m&&m.supports&&m.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))y(o);new MutationObserver(o=>{for(const l of o)if(l.type==="childList")for(const v of l.addedNodes)v.tagName==="LINK"&&v.rel==="modulepreload"&&y(v)}).observe(document,{childList:!0,subtree:!0});function u(o){const l={};return o.integrity&&(l.integrity=o.integrity),o.referrerPolicy&&(l.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?l.credentials="include":o.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function y(o){if(o.ep)return;o.ep=!0;const l=u(o);fetch(o.href,l)}})();const I="modulepreload",x=function(a){return"/ajackus/"+a},S={},C=function(m,u,y){let o=Promise.resolve();if(u&&u.length>0){let p=function(i){return Promise.all(i.map(f=>Promise.resolve(f).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};var v=p;document.getElementsByTagName("link");const r=document.querySelector("meta[property=csp-nonce]"),e=r?.nonce||r?.getAttribute("nonce");o=p(u.map(i=>{if(i=x(i),i in S)return;S[i]=!0;const f=i.endsWith(".css"),h=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${i}"]${h}`))return;const t=document.createElement("link");if(t.rel=f?"stylesheet":I,f||(t.as="script"),t.crossOrigin="",t.href=i,e&&t.setAttribute("nonce",e),document.head.appendChild(t),f)return new Promise((d,n)=>{t.addEventListener("load",d),t.addEventListener("error",()=>n(new Error(`Unable to preload CSS for ${i}`)))})}))}function l(r){const e=new Event("vite:preloadError",{cancelable:!0});if(e.payload=r,window.dispatchEvent(e),!e.defaultPrevented)throw r}return o.then(r=>{for(const e of r||[])e.status==="rejected"&&l(e.reason);return m().catch(l)})},L=["10","25","50","100","All"],c=[{id:crypto.randomUUID(),firstName:"Aarav",lastName:"Mehta",role:"Frontend Developer",department:"Engineering",email:"aarav.mehta@ajackus.com"},{id:crypto.randomUUID(),firstName:"Riya",lastName:"Shah",role:"Product Designer",department:"Design",email:"riya.shah@ajackus.com"},{id:crypto.randomUUID(),firstName:"Karan",lastName:"Joshi",role:"Backend Engineer",department:"Engineering",email:"karan.joshi@ajackus.com"},{id:crypto.randomUUID(),firstName:"Sneha",lastName:"Patel",role:"Project Manager",department:"Product Management",email:"sneha.patel@ajackus.com"}],N=["Engineering","Design","Product Management","Sales","Marketing"],B=["Frontend Developer","Backend Engineer","Product Designer","Project Manager","Sales Executive","Marketing Specialist","Data Analyst","HR Manager"],P=Object.freeze(Object.defineProperty({__proto__:null,count:L,departments:N,employees:c,roles:B},Symbol.toStringTag,{value:"Module"}));function q(a){const{id:m,firstName:u,lastName:y,email:o,department:l,role:v}=a,r=document.createElement("div");r.innerHTML=`
  ...
  `;const e=r.firstElementChild;return e.querySelector(".editBtn").onclick=()=>window.editEmployee(a),e.querySelector(".delBtn").onclick=()=>window.showDeletePopup(m),e}function k(a){a.innerHTML=`
  ...
  `;const m=a.querySelector("#headerSearch"),u=document.getElementById("showCount"),y=a.querySelector("#filterBtn"),o=a.querySelector("#filterPopup");y?.addEventListener("click",()=>{o.classList.toggle("hidden"),document.getElementById("filterFirstName").focus()}),document.addEventListener("click",r=>{!o.contains(r.target)&&!y.contains(r.target)&&o.classList.add("hidden")}),m?.addEventListener("input",r=>{const e=r.target.value.trim().toLowerCase(),p=c.filter(i=>i.firstName.toLowerCase().includes(e)||i.lastName.toLowerCase().includes(e)||i.email.toLowerCase().includes(e));window.updateGrid?.(p,u?.value||"All")});const l=a.querySelector("#applyFilter"),v=a.querySelector("#clearFilter");l.addEventListener("click",()=>{const r=a.querySelector("#filterFirstName").value.toLowerCase(),e=a.querySelector("#filterDepartment").value,p=a.querySelector("#filterRole").value,i=c.filter(f=>(!r||f.firstName.toLowerCase().includes(r))&&(!e||f.department===e)&&(!p||f.role===p));window.updateGrid?.(i,u?.value||"All"),o.classList.add("hidden")}),v.addEventListener("click",()=>{a.querySelector("#filterFirstName").value="",a.querySelector("#filterDepartment").value="",a.querySelector("#filterRole").value="",window.updateGrid?.(c,u?.value||"All"),o.classList.add("hidden")})}const w=JSON.parse(localStorage.getItem("employees"));w?.length&&c.splice(0,c.length,...w);let A=[...c],F=new Date().getFullYear();function E(a=A){const m=document.getElementById("app");m.innerHTML=`
  ...
  `,k(document.getElementById("headerContainer"));const u=document.getElementById("employeeGrid"),y=document.getElementById("showCount"),o=document.getElementById("sortBy"),l=document.getElementById("addEmployeePopup"),v=document.getElementById("addEmployeeBtn"),r=document.getElementById("cancelAddEmployee"),e=document.getElementById("addEmployeeForm"),p=document.querySelector(".setFocus"),i=e.elements.department,f=e.elements.role;C(async()=>{const{departments:t,roles:d}=await Promise.resolve().then(()=>P);return{departments:t,roles:d}},void 0).then(({departments:t,roles:d})=>{t.forEach(n=>{const s=document.createElement("option");s.value=n,s.textContent=n,i.appendChild(s)}),d.forEach(n=>{const s=document.createElement("option");s.value=n,s.textContent=n,f.appendChild(s)})});function h(t){u.innerHTML="";const d=y.value;(d==="All"?t:t.slice(0,parseInt(d))).forEach(s=>u.appendChild(q(s)))}y.addEventListener("change",()=>h(a)),o.addEventListener("change",()=>{const t=o.value;t&&a.sort((d,n)=>d[t].localeCompare(n[t])),h(a)}),l.addEventListener("click",t=>{t.target===l&&(l.classList.add("hidden"),e.reset())}),v.addEventListener("click",()=>{document.querySelector(".formText").textContent="Add Employee",document.querySelector(".addButton").textContent="Add",l.classList.remove("hidden"),p&&p.focus()}),r.addEventListener("click",()=>{l.classList.add("hidden"),e.reset()}),e.addEventListener("submit",t=>{t.preventDefault();const d=Object.fromEntries(new FormData(e).entries()),n=e.dataset.editId||null,s={id:n||crypto.randomUUID(),...d},g=c.findIndex(b=>b.id===n);console.log(g,n,s),g!==-1?c[g]=s:c.push(s),localStorage.setItem("employees",JSON.stringify(c)),e.dataset.editId="",e.reset(),l.classList.add("hidden"),E(c)}),h(a),window.showDeletePopup=t=>{const d=c.findIndex(n=>n.id===t);if(d!==-1){const n=document.createElement("div");n.innerHTML=`
